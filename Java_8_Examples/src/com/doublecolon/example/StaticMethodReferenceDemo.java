...
public class StaticMethodReferenceDemo {
	...
	// This method takes a functional interface as the type of its first
	// parameter. Thus it can accept a reference to any instance of that
	...
	public static void main(String[] args) {
		...
		// Here, a method reference to static method isEven of
		// IntPredicatesChecker is passed to numCheck().
		...
		// Here, a method reference to static method isPositive of
		// IntPredicatesChecker is passed to numCheck().
